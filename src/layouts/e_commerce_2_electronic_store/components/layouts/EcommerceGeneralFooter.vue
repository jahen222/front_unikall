    ...
    <div class="container-fluid text-left">
        <div class="row pl-2 pr-2 text-white font-12">
            ...
            <div class="col-3">
                ...
                <p class="mt-20">Subscribe to our email offers and promotions Subscribe to our email offers and
                    promotions</p>
                <p><input type="text" style="width:60%;" class="form-control d-inline" placeholder="Email" />
                    <button type="button" style="margin-bottom:4px;" class="btn btn-light d-inline">SUBSCRIBE</button>
                </p>
            </div>
        </div>
    </div>
